...
PawnWhite:   .hword 0x12, 0x22, 0x32,0x42,0x52,0x62,0x72,0x82, 0
PawnBlack:   .hword 0x17,0x27, 0x37,0x47,0x57,0x67,0x77,0x87, 0
RookBlack:   .hword 0x18,0x88, 0
RookWhite:   .hword 0x11,0x81,0
KnightBlack: .hword 0x28,0x78,0
KnightWhite: .hword 0x21, 0x71,0
BishopBlack: .hword 0x38, 0x68,0
BishopWhite: .hword 0x31, 0x61,0
QueenWhite:  .hword 0x41,0
QueenBlack:  .hword 0x48,0
KingWhite:   .hword 0x51,0
KingBlack:   .hword 0x58,0
...
Poll_until_white_select:
	...
	bne r10, r16, Arrow_In
	bne r9, r17, Arrow_In
	bne r8, r0, Check_input_white
...
Check_mouse_click_white:
	...
	Loop_King_White:
	ldw, r11, 0(r10)
	beq r11, r0, Poll_until_input_white
...
white_pawn_moves:
	...
	ldw r10, 4(sp)
	addi sp, sp,8
	br Poll_until_move_selected_white
white_rook_moves:
	addi sp, sp, -8
	stw ra, 0(sp)
	stw r10, 4(sp)
...
Poll_until_move_selected_white:
beq r8, r0, Poll_until_move_selected_white
...
Move_White_Piece:
	...
	mov r8, r0
	mov r9, r0
Poll_until_input_black:
	beq r8, r0, Poll_until_input_black
...
Check_mouse_click_black:
	...
	Loop_King_Black:
	ldw, r11, 0(r10)
	beq r11, r0, Poll_until_input_black
...
black_pawn_moves:
	...
	ldw r10, 4(sp)
	addi sp, sp,8
	br Poll_until_move_selected_black
black_rook_moves:
	addi sp, sp, -8
	stw ra, 0(sp)
	stw r10, 4(sp)
...
Poll_until_move_selected_black:
beq r8, r0, Poll_until_move_selected_black
