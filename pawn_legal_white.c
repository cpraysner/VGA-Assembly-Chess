...
void pawn_legal_white(int x, int y, int* pawnWhite, int* pawnBlack, int* rooksWhite, int* rooksBlack, int* knightsWhite, int*knightsBlack, int* bishopsWhite, int* bishopsBlack, int* queensWhite, int* queensBlack, int* kingsWhite, int* kingsBlack, int* array_legal){
	...
	compy=(queensBlack[0]&0xF);
	compx=(queensBlack[0]&0xF0);
	compx=compx>>4;
	if(compy==y+1&&compx==x){
		isLegal1=false;
		isLegal3=false;
	...
	compy=(queensWhite[0]&0xF);
	compx=(queensWhite[0]&0xF0);
	compx=compx>>4;
	if(compy==y+1&&compx==x){
		isLegal1=false;
		isLegal3=false;
	...
	compy=(kingsBlack[0]&0xF);
	compx=(kingsBlack[0]&0xF0);
	compx=compx>>4;
	if(compy==y+1&&compx==x){
		isLegal1=false;
		isLegal3=false;
	...
	compy=(kingsWhite[0]&0xF);
	compx=(kingsWhite[0]&0xF0);
	compx=compx>>4;
	if(compy==y+1&&compx==x){
		isLegal1=false;
		isLegal3=false;
