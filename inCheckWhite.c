...
#define true 1
#define false 0
int inCheckWhite(int y,int x,int* pawnWhite,int* pawnBlack,int* rookWhite,int* rookBlack,int* knightWhite,int* knightBlack,int* bishopWhite,int* bishopBlack,int* queenWhite,int* queenBlack,int* kingWhite,int* kingBlack){
		bool check=false;
		int tempX, tempY;
		int i=0;
		int j=0;
	...
	tempX=rookBlack[j]&0xF0;
	tempY=rookBlack[j]&0xF;
	tempX>>4;
	tempY=tempY+1;
...
i++;
	...
	j=0;
	while(j<2&&check==false){
	tempX=bishopBlack[j]&0xF0;
	tempY=bishopBlack[j]&0xF;
	tempX>>4;
	tempY=tempY+1;
	tempX=tempX+1;
	isLegal=true;
...
i++;
	...
	isLegal=true;
	tempX=queenBlack[0]&0xF0;
	tempY=queenBlack[0]&0xF;
	tempX>>4;
	tempY=tempY+1;
	if(check==false){
	while(tempY<9&&isLegal==true&&check==false){
...
i++;
	...
	tempX=queenBlack[j]&0xF0;
	tempY=queenBlack[j]&0xF;
	tempX>>4;
	tempX=tempX+1;
	isLegal=true;
	while(tempX < 9&&isLegal==true&&check==false){
